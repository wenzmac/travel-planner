    ...
    .then(response => {
      ...
      <div class="extra-results-flex">
        ...
        <div class="flex-box-forecast">
          <ul>
            <li>
              ${response.day1[0].date}
              <img src="https://www.weatherbit.io/static/img/icons/${response.day1[0].icon}.png">
              ${response.day1[0].maxTemp}°c
            </li>
            <li>
              ${response.day2[0].date}
              <img src="https://www.weatherbit.io/static/img/icons/${response.day2[0].icon}.png">
              ${response.day2[0].maxTemp}°c
            </li>
            <li>
              ${response.day3[0].date}
              <img src="https://www.weatherbit.io/static/img/icons/${response.day3[0].icon}.png">
              ${response.day3[0].maxTemp}°c
            </li>
            <li>
              ${response.day4[0].date}
              <img src="https://www.weatherbit.io/static/img/icons/${response.day4[0].icon}.png">
              ${response.day4[0].maxTemp}°c
            </li>
          </ul>
        </div>
        ...
        <div class="flex-box-forecast">
          <ul>
            <li>
              ${response.day5[0].date}
              <img src="https://www.weatherbit.io/static/img/icons/${response.day5[0].icon}.png">
              ${response.day5[0].maxTemp}°c
            </li>
            <li>
              ${response.day6[0].date}
              <img src="https://www.weatherbit.io/static/img/icons/${response.day6[0].icon}.png">
              ${response.day6[0].maxTemp}°c
            </li>
            <li>
              ${response.day7[0].date}
              <img src="https://www.weatherbit.io/static/img/icons/${response.day7[0].icon}.png">
              ${response.day7[0].maxTemp}°c
            </li>
            <li>
              ${response.day8[0].date}
              <img src="https://www.weatherbit.io/static/img/icons/${response.day8[0].icon}.png">
              ${response.day8[0].maxTemp}°c
            </li>
          </ul>
        </div>
      </div>
